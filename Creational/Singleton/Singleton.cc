...
class Singleton4 {
   ...
   public:
    Singleton4() {}
    ~Singleton4() {}
    static std::shared_ptr<Singleton4> GetInstance() { return instance; }

   private:
    static std::shared_ptr<Singleton4> instance;
};
std::shared_ptr<Singleton4> Singleton4::instance =
    std::make_shared<Singleton4>();
